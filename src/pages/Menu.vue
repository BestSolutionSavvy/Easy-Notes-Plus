...
<template>
  ...
  >
    ...
    >
      <MenuItem title="Home" :icon="homeIcon" to="/" @click="emit('closeMenu')" />
      <MenuItem title="Notebooks" :icon="notesIcon" to="/notebooks" @click="emit('closeMenu')" />
      <MenuItem title="Settings" :icon="settingsIcon" to="/settings" @click="emit('closeMenu')" />
    </div>
  </div>
</template>
